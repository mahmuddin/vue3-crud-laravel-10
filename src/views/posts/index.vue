...
<template>
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-12">
                <router-link :to="{ name: 'posts.create' }" class="btn btn-md btn-success rounded shadow broder-0 mb-3">ADD
                            ...
                            <tbody>
                                ...
                                <tr v-else v-for="(post, index) in posts" :key="index">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-danger rounded-sm shadow broder0">DELETE</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
